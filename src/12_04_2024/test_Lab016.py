...
@pytest.mark.smoke
@allure.title("Verify that Login is working in https://katalon-demo-cura.herokuapp.com/ website")
@allure.description("TC#1 - Simple Login check on https://katalon-demo-cura.herokuapp.com/ Website.")
def test_vwologin():
    ...
    # # -> id
    make_btn_css = driver.find_element(By.CSS_SELECTOR, "#btn-make-appointment").click()
